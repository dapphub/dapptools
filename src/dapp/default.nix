...
, coreutils, findutils, git, gnugrep, gnused, gnumake, hevm,
jshon, jq, nix , nodejs, perl, seth, shellcheck, solc, dapptoolsSrc }:
  ...
  postInstall =
    let
      path = lib.makeBinPath [
        coreutils findutils git gnugrep gnused gnumake hevm jshon jq nix nodejs perl seth solc
      ];
    in
      ''
