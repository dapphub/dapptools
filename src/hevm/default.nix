...
, lens-aeson, megaparsec, memory, microlens-aeson
, microlens-platform, monad-par, mtl, multiset, operational
, optparse-generic, process, QuickCheck, quickcheck-text
, regex-tdfa, restless-git, rosezipper, s-cargot, scientific
, secp256k1, semver-range, stdenv, tasty, tasty-hunit
...
mkDerivation {
  ...
  libraryHaskellDepends = [
    ...
    haskeline lens lens-aeson megaparsec memory microlens-aeson
    microlens-platform monad-par mtl multiset operational
    optparse-generic process QuickCheck quickcheck-text restless-git
    rosezipper s-cargot scientific semver-range temporary text
